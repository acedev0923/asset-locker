...
This project was built with assistance from Claude Code (claude-sonnet-4-6). Specifically:

- Scaffolding of the full project structure
- TanStack Start entry-point wiring (the `getRouter` export pattern, `createServerEntry` shape)
- Rust/WASM implementation
- Debugging TanStack Start's SSR pipeline

Architecture decisions, boundary discipline, and the overall design were human-driven.
